...
export interface CompetitionsContractFunctions {
  addPartnerMemberToCompetition: (member: string) => Promise<{wait: () => Promise<CompetitionsContractEvents>}>;
  createCheckpoint: (
    metadata: string,
  ...
  join: () => Promise<{wait: () => Promise<CompetitionsContractEvents>}>;
  ...
  role: () => Promise<number>;
  setWinners: (winners: string[]) => Promise<{wait: () => Promise<CompetitionsContractEvents>}>;
